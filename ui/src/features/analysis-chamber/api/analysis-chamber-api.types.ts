...
// Matches the member summary shape inside GET /organizations/:orgId tree response

export interface ChamberOrganizationMemberSummaryResponse {
  member_id: string;
...
export interface ChamberOrganizationTeamResponse {
  ...
  members: ChamberOrganizationMemberSummaryResponse[];
}
...
export interface ChamberCreateMemberRequest {
  display_name: string;
...
export interface ChamberTriggerAnalysisRequest {
  member_id: string;
