...
Để đặc tả phù hợp hơn cho flow dựng UI bằng Figma MCP, spec đã được phân rã thành các file chuyên biệt trong thư mục `Design/`:

- `00_SHARED_FOUNDATION.md` — nền tảng chung: design tokens, naming, component strategy, Figma MCP rules
- `01_LANDING_ORG_SELECTOR.md` — đặc tả màn hình Landing / Org Selector
- `02_CREATE_PROJECT_WIZARD.md` — đặc tả màn hình Create Project Wizard
- `03_STRATEGIC_BOARD.md` — đặc tả màn hình Strategic Board và các overlay
- `04_RESPONSIVE_BREAKPOINTS.md` — quy tắc responsive cho tablet/mobile
- `05_STATES_VISUAL.md` — loading, error, empty, validation states
- `06_FIGMA_TO_CODE_GUIDE.md` — mapping từ Figma sang code component/token

File này tiếp tục giữ vai trò plan tổng, scope, phase implementation và project context.
