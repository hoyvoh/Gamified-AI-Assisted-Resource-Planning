...
<h1 align="center">Gamified Resource Planning</h1>
...
We welcome contributions! This project follows an **agile ticket-based workflow**:

1. Check the [General Ledger](docs/planning/general-ledger.md) for available tickets
2. Read the ticket's `overview.md` and `design.md` in `docs/planning/phases/`
3. Follow the [Ticket Workflow](docs/guides/ticket-workflow.md)
4. Submit a PR — CI must be green, acceptance criteria must be ticked
